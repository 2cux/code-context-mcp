...
**GeneratedAt**: 2026-07-15T07:28:20.844Z
**Git commit**: 8a3a0c68a351bbea33ddc1cbeeefe2f768d446f8
**Git dirty**: true
...
|---|---|---|---|---:|---|
| 1 | 1. Source reproducibility | ✅ pass | 🔴 MUST | 223695ms | clean tracked-source build and quality tests passed |

### build

| # | Check | Status | Severity | Duration | Detail |
|---|---|---|---|---:|---|
| 1 | 2. TypeScript zero errors | ✅ pass | 🔴 MUST | 3626ms | tsc --noEmit returned zero errors |

### tests

| # | Check | Status | Severity | Duration | Detail |
|---|---|---|---|---:|---|
| 1 | 3. Vitest zero failures | ✅ pass | 🔴 MUST | 138157ms | 1596 tests passed, 63 test files, 0 failures |

### quality

| # | Check | Status | Severity | Duration | Detail |
|---|---|---|---|---:|---|
| 1 | 4. Compression Quality Gate | ✅ pass | 🔴 MUST | 360ms | Compression quality: 8/8 passed |
| 2 | 5. Memory Recall Quality Gate | ✅ pass | 🔴 MUST | 3157ms | 1 memory/recall test files, 0 failures |

### migration

| # | Check | Status | Severity | Duration | Detail |
|---|---|---|---|---:|---|
| 1 | 6. Fingerprint migration tests | ✅ pass | 🔴 MUST | 2928ms | 4 fingerprint migration tests passed |

### boundary

| # | Check | Status | Severity | Duration | Detail |
|---|---|---|---|---:|---|
| 1 | 7. Fast Path Boundary Gate | ✅ pass | 🔴 MUST | 6005ms | Fast path boundary gate has 0 blockers (29 checks) |
...
| # | Check | Status | Severity | Duration | Detail |
|---|---|---|---|---:|---|
| 1 | 9. Fresh npm install smoke | ✅ pass | 🔴 MUST | 24973ms | fresh HOME npm pack/install/CLI/MCP smoke passed |

### cli

| # | Check | Status | Severity | Duration | Detail |
|---|---|---|---|---:|---|
| 1 | 10. demo / value / doctor runnable | ✅ pass | 🔴 MUST | 4185ms | doctor: allPass=true; demo: ok; value: ok |
...
|---|---:|---|---|
| node scripts/release/source-reproducibility.mjs | 0 | PASS | { //   "verdict": "PASS", //   "trackedFiles": 429, //   "commands": [ //     [ //       "initialize temporary git metadata", //       "pass" //     ], //     [ //       "create temporary git branch", //       "pass" //     ], //     [ //   |
...
| node scripts/release/clean-install-smoke.mjs | 0 | PASS | CodeContext MCP - Fresh Install Package Smoke //  //   Build package artifacts... OK 4080ms //   npm pack... OK 2751ms //   Install packed tgz in temporary project... OK 14637ms //   Isolation preflight: fresh HOME and empty database direct |
| node dist/cli/index.js doctor | 0 | PASS | { //   "timestamp": "2026-07-15T07:28:17.327Z", //   "nodeVersion": "v24.13.0", //   "platform": "win32 x64", //   "checks": [ //     { //       "name": "node-version", //       "label": "Node version", //       "status": "pass", //       " |
...
| git rev-parse HEAD | 0 | PASS | 8a3a0c68a351bbea33ddc1cbeeefe2f768d446f8 |
| git status --porcelain | 0 | PASS | M artifacts/check-report.json //  M artifacts/check-report.md //  M reports/demo/first-run-value.json //  M reports/demo/first-run-value.md //  M reports/release/fast-path-boundary-check.json //  M reports/release/fast-path-boundary-check.m |
